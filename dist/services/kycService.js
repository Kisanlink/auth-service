 ...
 * ```
 */
const createKYCService = (apiClient) => {
    return {
        /**
        ...
        aadhaar: {
             ...
             */
            generateOTP: (request) => apiClient.post('/api/v1/kyc/aadhaar/otp', request),
            /**
             ...
             * ```
             */
            verifyOTP: (request) => apiClient.post('/api/v1/kyc/aadhaar/otp/verify', request),
        },
        /**
        ...
        status: {
             ...
             * ```
             */
            get: (userId) => apiClient.get(`/api/v1/kyc/status/${userId}`),
        },
    };
};
