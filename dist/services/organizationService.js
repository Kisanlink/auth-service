const createOrganizationService = (apiClient) => {
    return {
        ...
        assignRoleToGroup: (orgId, groupId, roleId) => apiClient.post(`/api/v1/organizations/${orgId}/groups/${groupId}/roles/${roleId}`, {}),
        ...
        addUserToGroup: (orgId, groupId, userId) => apiClient.post(`/api/v1/organizations/${orgId}/groups/${groupId}/users/${userId}`, {}),
